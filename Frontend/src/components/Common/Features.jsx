...
function Features() {
  ...
  return (
    <section 
      id="features" 
      className="section-spacing relative w-full min-h-screen md:min-h-screen bg-bottom md:bg-center bg-contain md:bg-cover bg-no-repeat overflow-hidden"
    ...
    >
      ...
      {/* Mobile Background - No Repeat */}
      <div
        className="absolute inset-0 -z-10 will-change-transform md:hidden"
        style={{
          backgroundImage: `url(/Backmobile.jpeg)`,
      ...
      <div className="container-custom relative z-10" >
        ...
        {/* Section Header */}
         <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20 animate-slide-up will-change-transform" data-scroll data-scroll-speed="1"
         >
             ...
             >
               <div className="glass glass-hover rounded-3xl p-4 md:p-8 group cursor-pointer border border-white/20 shadow-lg hover:shadow-2xl relative md:h-full">
                 ...
                 <div className="space-y-2 md:space-y-3">
                   ...
                   <p className="hidden md:block text-sm md:text-base text-custom-dark-gray leading-relaxed group-hover:text-custom-charcoal transition-colors">
                     {feature.description}
                   </p>
                 </div>

                 {/* Arrow */}
                 <div className="hidden md:flex mt-4 md:mt-6 items-center gap-2">
