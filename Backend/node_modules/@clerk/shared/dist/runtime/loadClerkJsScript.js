...
const require_versionSelector = require('./versionSelector-DXe3RRyU.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.4.0")}/dist/ui.browser.js`;
};
